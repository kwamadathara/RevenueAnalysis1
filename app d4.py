...
def merge_arear_data(arear_df, reader_df, reading_df, bpl_df):
    ...
    arear['Route'] = pd.to_numeric(arear['Route'], errors='coerce').astype('Int64').astype(str).str.strip()
    reader['RouteCode'] = pd.to_numeric(reader['RouteCode'], errors='coerce').astype('Int64').astype(str).str.strip()
